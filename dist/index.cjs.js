  ...
  props: {
    ...
    color: {
      ...
      validator: function validator(value) {
        return ['primary', 'secondary', 'light'].indexOf(value) >= 0;
      }
    }
  }
};
...
// For security concerns, we use only base name in production mode. See https://github.com/vuejs/rollup-plugin-vue/issues/258
script$1.__file = "Button.vue";

/* template */
var __vue_render__$1 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',_vm._g(_vm._b({staticClass:"w-full flex justify-around px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",class:{
      'text-white bg-primary hover:bg-primary-800': _vm.color === 'primary',
      'border-gray-300 text-gray-700 bg-white hover:bg-gray-100 ': _vm.color === 'light',
    }},'button',_vm.$attrs,false),_vm.$listeners),[(_vm.label)?_c('span',[_vm._v(_vm._s(_vm.label))]):(_vm.$slots.default)?_c('span',{staticClass:"flex w-full justify-around"},[_vm._t("default")],2):_vm._e()])};
var __vue_staticRenderFns__$1 = [];

  /* style */
  const __vue_inject_styles__$1 = undefined;
  /* scoped */
  const __vue_scope_id__$1 = "data-v-78f103b8";
  /* module identifier */
